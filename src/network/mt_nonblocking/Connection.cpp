...
void Connection::Start() {
    ...
    _event.events = EPOLLIN | EPOLLHUP | EPOLLERR | EPOLLET; //edge-triggered - файловый декскриптор возвращается только если с момента возврата произолши новые события
}
